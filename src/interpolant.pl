...
% 
%   The implementation is based on the algorithm presented in the
%   paper: Constraint Solving for Interpolation by Andrey Rybalchenko
%   and Viorica Sofronie-Stokkermans (VMCAI'07)
% 
%   Implementation: for 2nd and 3rd branch, we take One of LambdaLt >0
%   or One of MuLt >0
% 
%   This example gives is not captured by any one of the three branch
%   in the algorithm if we do not use equality constraints over
%   integers.
%   ```
